...
public class LasertagController extends Observable implements Initializable, EditableController {
    ...
    public LasertagController(BookingService bookingService, BookablePlaceDAO bookablePlaceDAO) {
